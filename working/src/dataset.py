...
class GraphemeDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        arr = np.load(os.path.join(self.images_dir, image_id+'.npy')) / 255.0
...
class DataModule(pl.LightningDataModule):
    def __init__(self, df:pd.DataFrame, frac=1, validation_split=.25, train_batch_size=4, test_batch_size=4):
